...
- **Instructors List Page** - Select a page to be set as an instructors list page. This page shows the list of instructors. The page should contain shortcode `[masteriyo_instructors_list]`.
