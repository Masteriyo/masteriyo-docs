...
For full setup instructions, see the [Two-Factor Authentication](/premium-addons/two-factor-authentication) documentation. Two-Factor Authentication is built into Masteriyo Pro — it moved from an add-on into core in v3.1.0, so no add-on activation is needed.
