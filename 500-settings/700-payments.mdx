...
</br>Now follow the below steps for setting up your PayPal account.

#### Enable Paypal ####  
- Navigate **Masteriyo**->**Settings**->**Payments**.
- Click on the **Standard PayPal** option and turn on **Enable** button.

![paypal-walkthrough-menu](https://user-images.githubusercontent.com/24367265/185129055-f11f7e58-7e32-45f7-86a2-90d65164bcfd.png)
...
- **PayPal Email**  
  Enter your valid PayPal email address here so that you can receive payments from your users.
...
![paypal-walkthrough-masteriyo](https://user-images.githubusercontent.com/24367265/185129182-30aa30fe-401e-406b-9ca8-bf54d2441e70.png)
