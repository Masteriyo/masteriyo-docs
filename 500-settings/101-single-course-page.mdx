...
Select from pre-designed templates to control how your single course pages appear:  
  ...
  - **Minimal**: Full-width featured image banner above a two-column layout — course details in the main column, price/enroll button, stats and highlights in the right sidebar, with the course content shown full-width below.
