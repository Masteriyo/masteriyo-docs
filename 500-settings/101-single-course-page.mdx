...
## Display
### Template
Choose one of four pre-designed layouts — Simple, Modern, Minimal, or Immersive — to control how your single course pages appear, plus custom templates when Elementor or Bricks is active. See [Course Layout](/course-creation/course-layout) for a full comparison and setup steps.
