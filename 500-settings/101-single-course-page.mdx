...
## Display
### Template
Choose one of four pre-designed layouts — Simple, Modern, Minimal, or Immersive — to control how your single course pages appear, plus custom templates when Elementor or Bricks is active. See [Single Course Layout](/course-creation/single-course-layout) for a full comparison and setup steps.
