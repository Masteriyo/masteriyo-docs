...
A pop-up will appear for tax configuration.   
Now, choose the country from the dropdown.  
Enter your tax percentage in the box. (e.g., 13 for 13%)

Uncheck **Apply single tax for entire country** if you want to apply individual tax rates for each region of the country.   
After that, you can pick the specific state or region:  
**Enter Tax Rate**: Input the tax percentage for the regions you select. For non-selected states, you can seta  default tax rate. Click **"Add"** to save the regional tax settings 
