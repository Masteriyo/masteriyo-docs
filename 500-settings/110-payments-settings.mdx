...
excerpt: Set up payments to sell courses in Masteriyo — store, currency, taxes, checkout fields, PayPal, Stripe, offline payment, and bank wire transfer details.
---
...
### Taxes [Pro] 
Setting up taxes in Masteriyo LMS allows you to automatically calculate and collect taxes on course purchases based on your students' locations. Tax settings help you comply with local tax regulations and automatically calculate taxes on your course sales.
...
- **Enable** - Enable this option to use the Stripe payment method.
  ...
  - **Test Publishable Key** - Get your API credentials from Stripe and add the test publishable key here.
  - **Test Secret Key** - Add the test secret key from Stripe here.
  - **Webhook Secret Key** - Get your webhook secret key from Stripe and add it here.
