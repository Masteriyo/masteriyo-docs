---
title: How to tests conflict on your site?
show_child_cards: true
excerpt: Learn how to tests conflict on your site. If the designs or some features are not working on your site, you must do the plugin/ theme conflict test.
---
