...
After taking all the screenshots, you need to send those screenshots to our support team.  Visit the [Masteriyo website](https://masteriyo.com/word

-lms); you will see the chat box in the bottom right corner, where you can send all screenshots of your issues. They will look into your problem and come up with a possible solution by looking into these screenshots.
