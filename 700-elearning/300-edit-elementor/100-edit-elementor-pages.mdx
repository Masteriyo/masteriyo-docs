---
title: How to edit Elementor pages in eLearning Theme?
show_child_cards: true
excerpt: Learn basics of using eLearning Theme. How to edit Elementor pages in eLearning Theme.
---

To learn about Elementor in detail, visit their site at [https://docs.elementor.com/](https://docs.elementor.com/)

To edit your pages with Elementor, follow the steps shown below:

### Go to the Elementor Editor Page 
...
```
Note: If Edit with Elementor is not visible for a page on the front side as well as the dashboard, it means that the particular page has not been built using Elementor. To edit that page with Elementor, navigate to Pages > All Pages, hover over it, and click on Edit. Now click on the Edit with Elementor button above the page editor. 
```
...
You can edit your page in Elementor using a variety of different widgets. If you click on the section, you need to edit, and a corresponding editor section will appear on the left. You can then use that editor to customize the section. 
