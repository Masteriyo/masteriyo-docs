...
excerpt: Learn basics of using eLearning Theme. How to create a Elementor page similar to the demo page.
---

### How to create a Elementor page similar to the demo page? 

After importing the eLearning demo to your site, you can add as many pages as you like. If you want your page to look similar to the other pages in our demo, then you can do so as well. Just follow the steps below:
