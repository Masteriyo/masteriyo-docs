...
# How to change/remove the Logo image in eLearning?

After importing one of the eLearning demos like Business, Charity, etc. changing the logo from **Customizer** won’t affect the homepage. It is due to the fact that eLearning has two ways of adding a logo. The first is using the **Customizer** and the second way is from the **Page Settings**.
...
To change or upload logo using **Page Settings** or follow the steps below:
