...
```Note: 
If you want different typography for the different sections instead of the same, you can override the base typography using the typography option provided in the specific sections. For example, to choose different typography for the Menu, go to that specific section of the Customizer and select the typography. That will override whatever typography has been selected as the Base Typography.
```
