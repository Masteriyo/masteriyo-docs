...
-In the color option, you will see two available options:
  ...
  - [Container](https://github.com/Masteriyo/masteriyo-docs/blob/elearning/700-elearning/400-customizer%5Bglobal%5D/300-site-layout.mdx#how-to-manage-container)
  
  - [Sidebar Layout](https://github.com/Masteriyo/masteriyo-docs/blob/elearning/700-elearning/400-customizer%5Bglobal%5D/300-site-layout.mdx#how-to-change-the-sidebar-layout)
