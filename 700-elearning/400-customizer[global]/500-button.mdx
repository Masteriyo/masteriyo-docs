...
```
Note: If you want different colors and designs for the button in different sections, you can override the default button settings with the option provided in specific sections. For example, To style the header button, go to the Header Section of the Customizer and select the required option.
```
