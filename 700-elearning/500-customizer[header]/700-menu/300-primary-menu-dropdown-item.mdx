...
With eLearning, it is possible to configure how the items in the Dropdown Menu of your Primary Menu appear. You will have access to the following options:
