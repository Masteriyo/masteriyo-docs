...
![Allow Zapier to access Masteriyo Account](https://raw.githubusercontent.com/Masteriyo/masteriyo-docs/main/assets/images/webhooks/allow-zapier-to-access-masteriyo-account.png)
...
9. Click on the **Continue** button to proceed further.
...
10. You can now test the trigger to confirm your trigger. Once you see the record, you can click on **Continue with selected record**. 
...
Example:
 ...
 ![Enter Data for Action](https://raw.githubusercontent.com/Masteriyo/masteriyo-docs/main/assets/images/webhooks/enter-data-for-action.png) 
