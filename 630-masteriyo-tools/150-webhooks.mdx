...
Now, whenever a student is enrolled in the course, wwebhook will mark the course as completed. 

<Callout>
  {" "} 
In this documentation, we used **Student Enrolled** as the trigger which lead the action of **Course Completion**. Similarly, you can use other Triggers and set other Action. 
</Callout>
