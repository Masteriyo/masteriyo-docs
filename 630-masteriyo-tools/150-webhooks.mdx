...
1. First, [enable the Zapier addon](https://docs.masteriyo.com/premium-addons/zapier-integration).
...
<Callout>
In this documentation, we used **Student Enrolled** as the trigger that leads to the action of **Course Completion**. Similarly, you can use other triggers and set other actions. 
</Callout>
