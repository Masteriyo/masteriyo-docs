...
5. Under **Account**, click on **Sign In** to get a new interface asking for your site URL and the API key. 
6. Go back to your WordPress website, and navigate to **Masteriyo > Zapier**. Here, you'll see the API key. Copy and paste the key and hit **Yes, Continue to Masteriyo**. 
6. Click on **Continue** button to proceed further.
7. You can now test the trigger to confirm your trigger. Once you see the record, you can click on **Continue with selected record**. 

## Using Zapier to Send Action Webhooks to Masteriyo

1. Click on **Action** and search and choose "Webhooks by Zapier" as your action app.       
...
Example:
       ...
       Headers:
       X-WP-Webhook-Token: [your-webhook-token]
You can find the Webhook token from your WordPress dashboard. So, navigate to **Webhook** and click on the settings icon. Now, you'll see the webhook token in the side interface. Copy this token and paste under **Headers** of the Zap you're currently creating. 
Click on **Continue** to test the Zap.
Under the **Data out**, you can see the relevant data.        
This means you've successfully triggered webhooks with Zapier and sent the action to Masteriyo. 
