...
10. You can now test the trigger to confirm your trigger.  
...
![Configure Remaining Action](https://raw.githubusercontent.com/Masteriyo/masteriyo-docs/main/assets/images/webhooks/configure-remaining-action.png)
