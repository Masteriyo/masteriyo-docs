...
excerpt: "Official Masteriyo LMS documentation: step-by-step guides to create and sell online courses, set up quizzes, certificates, payments, and addons in WordPress."
---
...
<div className="mt-8 grid gap-6 md:grid-cols-2">
  ...
  <Card
    ...
    subtitle="See Masteriyo in action without installing it on your system. Clicking this link creates a demo where you can test Masteriyo."
  />
</div>
