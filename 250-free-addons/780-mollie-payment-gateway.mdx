...
o	Obtain this key from your Mollie dashboard under Developers > API Keys.
o	Paste it here after disabling Sandbox.

Disable Sandbox, if you’re ready with the transaction for real. 
Click in **Save Setting** to save all configured Mollie settings. 
