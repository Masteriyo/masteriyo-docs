...
excerpt: Enable and configure Mollie as a payment gateway for your Masteriyo LMS courses, including API keys, Sandbox testing, and going live.
---
...
![enable-mollie-addon](https://github.com/user-attachments/assets/a85649f6-3608-4f6f-8052-30a7f12eee32)

## Step 2: Configure Mollie's Settings
Go to **Masteriyo > Settings > Payments > Mollie**  to customize the payment gateway:

![navigate-to-mollie-in-dashboard](https://github.com/user-attachments/assets/26e8adf7-d6ad-4ee0-9895-b47c24a9ae8e)
...
![configure-mollie-settings](https://github.com/user-attachments/assets/116368c3-545b-412a-8838-5b6438b5d86a)
...
Disable Sandbox, if you’re ready with the transaction for real. Click on **Save Settings** to save all configured Mollie settings. 
...
<Callout>
  {" "} 
  To test Mollie payments with automatic status updates, your website must be hosted on a publicly accessible domain (e.g., .com, .me, .net). Mollie checkout flows **will not work** in local/test environments (e.g., localhost), as Mollie cannot communicate with non-public domains. However, on local or non-public domains you will not have access to Mollie webhooks.
</Callout>            
...
As soon as the customer clicks on **Proceed to Mollie**, they are redirected to Mollie’s secure payment page, where they can enter card details and confirm the transaction. 
...
## Other Useful Resources:
 - [Use Stripe as a Payment Gateway for your LMS](/free-addons/stripe-payment-gateway)
