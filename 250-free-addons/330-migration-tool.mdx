...
![migration-tool-from-masteriyo](https://raw.githubusercontent.com/Masteriyo/masteriyo-docs/main/assets/images/migration-tool/migration-tool.png)
...
<Callout>
  {" "}
  Note: You’ll only see the LMS options, after you install and activate the respective
  plugin. Before migrating, confirm that both source and destination plugins are
...
![migrate-from-learnpress](https://raw.githubusercontent.com/Masteriyo/masteriyo-docs/main/assets/images/migration-tool/learnpress-migration.png)
