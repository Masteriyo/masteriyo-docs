...
excerpt: Integrate BuddyPress with Masteriyo to create course-specific social groups and share LMS activities like enrollment, progress, and completion.
---
...
- [BuddyPress Integration add-on activated.](/getting-started/activate-masteriyo-addons)
...
- In the Group Activities section, all the activities related to Masteriyo LMS that you checked before creating the group will be displayed here.
