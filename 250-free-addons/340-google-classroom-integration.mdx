...
- Activate the [Google Classroom Integration add-on](https://docs.masteriyo.com/getting-started/activate-masteriyo-addons)
...
![enable-classroom-api](https://github.com/Masteriyo/masteriyo-docs/assets/75772539/8d19d402-5d2a-4e00-98c6-e1e9a7eab1ac)
...
![other-actions](https://github.com/Masteriyo/masteriyo-docs/assets/75772539/7a52f58d-ff29-4d9b-b01c-e62b766a115d)
...
- **Clear Course Cache** - Deletes the existing cached data and requests new course data from Google Classroom.
- **Clear All Data** - Deletes all the data, so users have to sign in again to sync the data to Google Classroom.
