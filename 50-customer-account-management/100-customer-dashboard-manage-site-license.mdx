---
title: Log in to the Customer Dashboard, Download Masteriyo Pro, and Manage Site License
excerpt: Log in to the Lemon Squeezy Customer Dashboard to download the latest Masteriyo Pro plugin and manage or deactivate your site license.
---
...
- First, log in to Lemon Squeezy via this link: [https://app.lemonsqueezy.com/my-orders](https://app.lemonsqueezy.com/my-orders).
...
- Use the **Download** button to download the latest version of the plugin.
...
<Callout>
  {" "}  
  **Note:** Once you deactivate the license from your site, you can use the license on a new site. 
</Callout>
