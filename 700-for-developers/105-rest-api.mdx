...
- <Checkmark /> **Masteriyo LMS v1.15.1 or higher** (Free version)
- <Checkmark /> **Masteriyo LMS Pro v2.0 or higher** (For premium features)
- <Checkmark /> **HTTPS connection** (can also be accessed over HTTP, but HTTPS is recommended for security)
