...
excerpt: Masteriyo LMS REST API guide - generate API keys, authenticate with Basic Auth, and read, create, update, or delete courses and LMS data over HTTP.
---
...
- **Read Data**: Fetch courses, user progress, categories, and more.  
...
**Step 2:** Click the **Add New** button, and configure the details:  
...
### Deleting Data
Here’s an example of deleting a course.
...
[Masteriyo LMS REST API Endpoints](/for-developers/rest-api-endpoints)
### Getting Help
