...
| Ability                            | Description                    |
| ----------------------------------- | ------------------------------- |
| `masteriyo/course-category-list`   | List all course categories     |
| `masteriyo/course-category-get`    | Get a single course category by ID |
| `masteriyo/course-category-create` | Create a new course category   |
| `masteriyo/course-category-update` | Update a course category       |
| `masteriyo/course-category-delete` | Delete a course category       |

### Course Tag

| Ability                       | Description                |
| ------------------------------ | --------------------------- |
| `masteriyo/course-tag-list`   | List all course tags       |
| `masteriyo/course-tag-get`    | Get a single course tag by ID |
| `masteriyo/course-tag-create` | Create a new course tag    |
| `masteriyo/course-tag-update` | Update a course tag        |
| `masteriyo/course-tag-delete` | Delete a course tag        |

### Course Difficulty

| Ability                              | Description                       |
| -------------------------------------- | ----------------------------------- |
| `masteriyo/course-difficulty-list`   | List all course difficulties      |
| `masteriyo/course-difficulty-get`    | Get a single course difficulty by ID |
| `masteriyo/course-difficulty-create` | Create a new course difficulty    |
| `masteriyo/course-difficulty-update` | Update a course difficulty        |
| `masteriyo/course-difficulty-delete` | Delete a course difficulty        |

### Course Review

| Ability                          | Description                   |
| ----------------------------------- | -------------------------------- |
| `masteriyo/course-review-list`   | List all course reviews       |
| `masteriyo/course-review-get`    | Get a single course review by ID |
| `masteriyo/course-review-create` | Create a new course review    |
| `masteriyo/course-review-update` | Update a course review        |
| `masteriyo/course-review-delete` | Delete a course review        |

### Course Q&A

| Ability                      | Description                |
| ------------------------------ | ----------------------------- |
| `masteriyo/course-qa-list`   | List all course Q&A entries |
| `masteriyo/course-qa-get`    | Get a single course Q&A entry by ID |
| `masteriyo/course-qa-create` | Create a new course Q&A entry |
| `masteriyo/course-qa-update` | Update a course Q&A entry   |
| `masteriyo/course-qa-delete` | Delete a course Q&A entry   |
| `masteriyo/course-qa-restore`| Restore a trashed course Q&A entry |

### Course Progress

| Ability                       | Description             |
| -------------------------------- | -------------------------- |
| `masteriyo/progress-get`      | Get course progress     |
| `masteriyo/progress-update`   | Update course progress  |
