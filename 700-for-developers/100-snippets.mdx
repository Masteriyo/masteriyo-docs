---
title: Code Snippets
excerpt: PHP code snippets to customize Masteriyo LMS - change offline order status, sort courses, redirect after login or registration, resize course images, coupons.
---

All of the code snippets for modifying existing features can be found below. Check out [this link](https://docs.masteriyo.com/faqs/custom-code-snippet) if you do not know where to add custom code snippets to your site.
