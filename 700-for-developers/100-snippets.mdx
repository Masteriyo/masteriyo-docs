...
All of the code snippets for modifying existing features can be found below. Check out [this link](/faqs/custom-code-snippet) if you do not know where to add custom code snippets to your site.
...
<Callout>
  {" "}  
  Want to know where and how to add code snippets? Check out [this link](/faqs/custom-code-snippet) 
</Callout>
...
<Callout>
  {" "} 
  You can change the 400 and 400 image sizes according to your needs. Want to know where and how to add code snippets? Check out [this link](/faqs/custom-code-snippet) 
</Callout>
