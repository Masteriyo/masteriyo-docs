...
<Callout>
  {" "}  
  Want to know where and how to add code snippets? Check out [this link](https://docs.masteriyo.com/faqs/custom-code-snippet) 
</Callout>
...
<Callout>
  {" "} 
  You can change the 400 and 400 image sizes according to your needs. Want to know where and how to add code snippets? Check out [this link](https://docs.masteriyo.com/faqs/custom-code-snippet) 
</Callout>
