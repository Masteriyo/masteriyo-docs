...
![configure-settings-for-live-stream-lesson](https://github.com/user-attachments/assets/2b217f12-6741-40aa-b79c-67c6536aab7a)
...
Meanwhile, you need to configure Player settings with YouTube API keys before you can transform a live stream into a normal video lesson. So, navigate to **Masteriyo > Settings > General > Player**.     
