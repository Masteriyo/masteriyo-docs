...
excerpt: "Host live stream lessons in Masteriyo: add a YouTube live URL, set start and end times, enable live chat, and convert streams to video lessons."
---

<Callout>
  {" "} 
**Note:** This instruction is for creating Live Stream lessons for your course. If you missed the documentation for creating a complete course, please review it here: [Complete Course Creation](/course-creation/complete-course-creation).
</Callout>

## Adding Live Stream Lesson

Navigate to **Masteriyo > Courses** and choose the course where you want to add a live stream lesson. Now, switch to the Builder tab and you will be directed to a new interface where you can add Live Stream Lessons.
...
- **Transform live stream to video [Pro]**: Toggle the option to convert the Live Stream to normal video so that users can access the video after the live session ends.  

To transform a live stream into a normal video lesson, you first need to configure the **Player** settings with a YouTube API key. So, on your new tab, navigate to **Masteriyo > Settings > General > Player**.     
...
Users can also enable or disable live chat as per their preference. 
