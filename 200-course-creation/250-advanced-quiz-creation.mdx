...
<Callout>
  {" "} 
**Prerequisite:** 
o	Masteriyo LMS plugin v1.16.0 or above installed and activated    
o	For importing a quiz, prepare the quiz file in a valid .json format
</Callout>
...
At the frontend, you can see the import quiz similar to the image below:
