...
- **Add New Question:** You can create a new question from here.    
- **Add from Question Bank:** From here you can choose the existing quiz's question and add them to your course without recreating.   
Question bank is a centralized repository for Masteriyo LMS where you can find existing questions created with your LMS. Click on this option and a new interface will pop-up showing you all the existing questions.   
