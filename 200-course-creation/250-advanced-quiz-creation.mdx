...
Now, click on **Add New Question** and you'll get two options:    
  ...
  **Add from Question Bank:** From here you can choose the existing quiz's question and add them to your course without recreating. Question bank is a centralized repository for Masteriyo LMS where you can find existing questions created with your LMS.   
