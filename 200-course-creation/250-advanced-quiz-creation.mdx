...
- Navigate to course builder of the course where you want to create quiz. Now, click on **Add New Content**.
- Select content type as **Quiz**. A new interface for adding quiz will be shown.
...
Question bank is a centralized repository for Masteriyo LMS where you can find existing questions created with your LMS. Click on this option and a new interface will pop-up showing you all the existing questions. From here you can choose the existing quiz's question and add them to your course without recreating.

You can choose your preferred action:  

**Add to Quiz:** Adds the question directly (removes it from the bank).  
**Duplicate and Add to Quiz:** Creates a copy and adds to your quiz, while keeping the original in the bank.  

![select-quiz-and-or-duplicate](https://github.com/user-attachments/assets/f88a9d18-3ed8-4dac-acec-3da1ed749c83)

Now, if you want to reuse any of those, you can select and click on **Add Selected** and then hit the **Update** button. It will now automatically add those question to your quiz. 

![import-question-from-question-bank](https://github.com/user-attachments/assets/dfdcee5a-6450-4687-aab5-d8d26679291f)

## Add New Question

If you want to add new question, you will need to add questions and description for the quiz. If you would like to do this, please follow the steps below.

- Click on the **Add New Question** and you'll see **Untitled Question**. Again click on untitled question and you can now add your question and configure other settings.    
