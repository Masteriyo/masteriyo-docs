...
This is a question type where the answers are to be matched with the prompts. You can select whether you are matching text to text, image to text, text to image or image to image. 

        When you select any option related to image, you can upload your image from the uploader button.
