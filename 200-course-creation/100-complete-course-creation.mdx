...
- **Video Lesson** - Deliver engaging educational content through high-quality video lessons. Ideal for visual learners and designed to enhance course interactivity on your LMS. To learn how to add Video Lessons, check this link: 

- **Live Stream** - Host real-time classes with live streaming. Enable interaction between instructors and students for dynamic, collaborative learning experiences. To learn how to add Live Stream, check this link:
