...
![section-name](https://user-images.githubusercontent.com/3048991/172194764-e3fd714f-697c-4eca-bb7f-c676d77bab87.png)
 ...
 - **Text Lesson**
A text-based learning module where educators can share detailed course content, including formatted text, links, and resources. Perfect for self-paced learning in your LMS platform.

- **Video Lesson**
Deliver engaging educational content through high-quality video lessons. Ideal for visual learners and designed to enhance course interactivity on your LMS.

- **Live Stream**
Host real-time classes with live streaming. Enable interaction between instructors and students for dynamic, collaborative learning experiences.

- **Quiz**
Evaluate students’ understanding with customizable quizzes. Include multiple-choice, true/false, and other question types for effective learning assessments.

- **Google Meet [Pro]**
Integrate Google Meet directly into your LMS for seamless virtual classroom sessions. Easily schedule and host secure video meetings with your students.

-  **Zoom Meeting [Pro]**
Conduct live virtual classes using Zoom integration. Enhance online learning with video conferencing, screen sharing, and interactive features.

-  **Assignment [Pro]**
Enable learners to submit assignments directly through the LMS. Track submissions, provide feedback, and ensure a smooth evaluation process.
