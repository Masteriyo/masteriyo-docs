...
### Adding Text Lesson, Video Lesson, Live Stream, Quiz, Google Meet, Zoom Meeting, Assignment
...
![Select Your Content Type](https://github.com/user-attachments/assets/c6bf3bf2-b22e-4fac-9a6e-38dfe277020d)
 ...
 - **Text Lesson** - A text-based learning module where educators can share detailed course content, including formatted text, links, and resources. Perfect for self-paced learning in your LMS platform. To learn how to add Text Lessons, check this link: 
