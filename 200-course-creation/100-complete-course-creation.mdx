...
<<<<<<< Updated upstream
- Now, if you have a video for the lesson, you can add it. Currently, Masteriyo supports videos from 5 different sources **Youtube**, **Vimeo**, **Self hosted**, **EmbedVideo** and **Live Stream**. If you select Youtube, Vimeo or Live Stream you will be presented with a field to enter the video URL. If you select Embed Video in Video Source, you will be presented with a field to enter Video iframe.
  If you select Self Hosted in Video Source, you can upload video clicking on **Add Video Link**.
=======
- Now, if you have a video for the lesson, you can add it. Currently, Masteriyo supports videos from 5 different sources **Youtube**, **Vimeo**, **Self hosted**, **EmbedVideo**  and **Live Stream**. If you select Youtube, Vimeo or Live Stream you will be presented with a field to enter the video URL. If you select Embed Video in Video Source, you will be presented with a field to enter Video iframecan upload video clicking on **Add Video Link**. If you select Self Hosted in Video Source, you can upload video clicking on **Add Video Link**.
>>>>>>> Stashed changes
...
![advance-analytics](https://github.com/Masteriyo/masteriyo-docs/assets/75772539/45c2c0a4-3021-4d4f-8cb1-44ad95d200b5)

In the Masteriyo > Courses, you can find the _Reports_ button on the ACTIONS column. This button will provide you with advanced analytics for the selected course.
