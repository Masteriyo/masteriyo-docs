---
title: Private Course Creation [Pro]
...
- Active [installation of Masteriyo LMS](/getting-started/installation#installing-masteriyo-lms-pro-version).
- **Manual Enrollment addon** (included with all paid plans, Basic and above).
...
For a detailed guide, check out the [guide on creating a complete course](/course-creation/complete-course-creation).
...
That’s it. Now, you can navigate to **Course Builder** to configure the course with [lessons](/course-creation/text-lesson-creation), [quizzes](/course-creation/advanced-quiz-creation), and so on.

<Callout>
  {" "}
  **Note:** Do not click the **Publish** button for your private course.
</Callout>
...
- Enrolled students will be notified via email and can see the private course in their dashboard.
