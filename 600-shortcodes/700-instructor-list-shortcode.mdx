...
excerpt: Display a list of instructors (teachers) with the [masteriyo_instructors_list] shortcode — columns, IDs, order, and pagination attributes with examples.
---
