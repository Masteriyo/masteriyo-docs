...
**Note**: By default, our setup wizar will create a new page named **Courses** and use this page as courses listing page.
- **Learning**: Here, you need to select a page that will show or run individual course when students start the course.
