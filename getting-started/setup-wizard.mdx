...
- **Or**, if you are already familiar with Masteriyo LMS and don't need to run this setup wizard, you can simply skip this process by clicking on **Skip to Dashboard**.
