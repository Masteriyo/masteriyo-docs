...
- **Account**: Here, you need to select a page that will show account of any instructor or student.
  ...
  **Note**: By default, our setup wizard will create a new page named **Account** and use it. Also, adding any content in this page itself in the dashboard is meaningless and does not show anywhere in the frontend.
  
- **Checkout**: Here, you need to select a page that will show the checkout page whenever a student purchases a course.

  **Note**: By default, our setup wizard will create a new page named **Checkout** and use it. Also, adding any content in this page itself in the dashboard is meaningless and does not show anywhere in the frontend.
