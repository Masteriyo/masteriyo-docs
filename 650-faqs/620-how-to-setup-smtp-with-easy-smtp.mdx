---
title: How to Set Up SMTP Using the Easy WP SMTP Plugin?
show_child_cards: true
excerpt: "Set up SMTP in WordPress with the Easy WP SMTP plugin — host, port, and encryption settings for Gmail, Yahoo, and Outlook to fix email delivery."
---
...
Here, you can set the required SMTP settings. For this documentation, we will use the most common setup. Here, choose **Other SMTP**.
