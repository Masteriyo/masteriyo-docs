...
excerpt: Fix Masteriyo account page or dashboard errors 'Sorry, you are not allowed to read resources' and 'roles.includes is not a function' caused by role permissions.
---

## Masteriyo account page error
...
![Permission issue](https://github.com/user-attachments/assets/16b1e990-e3f0-4db7-885d-0f0e49917a71)
...
[Want to know how to activate Masteriyo add-ons?](https://docs.masteriyo.com/getting-started/activate-masteriyo-addons)
...
If you are trying to access your Dashboard >> Masteriyo >> any settings or options and see the message "Sorry, you are not allowed to read resources" or "TypeError: roles.includes is not a function," this is likely a permission issue. A third-party plugin may be customizing the admin or instructor roles. Please check if a plugin is overriding these roles.
