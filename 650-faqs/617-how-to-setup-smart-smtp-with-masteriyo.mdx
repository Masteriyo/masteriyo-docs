---
title: How to Set Up SMTP Using the SmartSMTP Plugin?
...
- Navigate to **Plugins > Add New** on your WordPress dashboard.
...
Once everything is configured, WordPress will route emails (such as form submissions, order confirmations, and password resets) through the SMTP server instead of PHP's default `mail()` function.   
