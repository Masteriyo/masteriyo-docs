...
excerpt: Safely add custom code snippets to your WordPress site using the Code Snippets plugin or a child theme's functions.php file.
---
...
To keep your customizations even after updating your theme, you can create a **child theme** and insert the code snippet there. If you haven't already, go to the [WordPress child theme documentation](https://developer.wordpress.org/themes/advanced-topics/child-themes/) and follow the instructions to make a child theme for your site.

Assuming you're familiar with FTP and cPanel, the safest approach is to add the code snippet via FTP/cPanel (Sometimes, you might accidentally mistype the code, which can cause problems on your site.)
