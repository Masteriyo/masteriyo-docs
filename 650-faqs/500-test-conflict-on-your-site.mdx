...
<Callout>
  {" "}  **Note:** Troubleshooting Mode does not affect your site visitors; they will continue to view your site as usual. </Callout>
...
<Callout>
  {" "}  **Note:** Always use caution while testing for conflicts on a live website. A backup is advised before you start. </Callout>
