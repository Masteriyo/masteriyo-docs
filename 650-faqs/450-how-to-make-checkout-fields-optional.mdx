...
excerpt: Make Masteriyo checkout billing fields optional or remove them entirely with the masteriyo_checkout_fields filter — code snippets and field keys included.
---
...
## Example 1: Make **all** built-in fields optional
...
| `billing_email` | Email address (used for account creation and should normally stay required) | 
