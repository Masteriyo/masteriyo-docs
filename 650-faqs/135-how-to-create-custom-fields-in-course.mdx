...
Masteriyo allows admins to extend course creation with additional fields and content through a third-party plugin or custom code. Admins can now dynamically add new fields in the course builder. 
...
- The system supports various fields, including text, number, textarea, password, date, time, checkbox, radio, switch, and select.  
...
- **type**: text, number, textarea, password, date, time, checkbox, radio, switch, or select
- **label**: field label shown in the builder
