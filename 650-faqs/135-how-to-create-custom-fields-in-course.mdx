...
Masteriyo allows admins to extend course creation with additional fields and content througha  third-party plugin or custom code. Admin can now dynamically add new fields in the course builder. 
