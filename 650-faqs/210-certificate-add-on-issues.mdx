...
excerpt: "Fix Certificate Builder issues in Masteriyo: certificate add-on not visible, and certificate background or image not displaying (enable PHP GD2 extension)."
---
...
- Deactivate the Masteriyo LMS plugin (Free or Pro, whichever you are using).
