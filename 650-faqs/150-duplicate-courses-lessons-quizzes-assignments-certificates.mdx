...
In Masteriyo, you can duplicate lessons, quizzes, and certificates in the free plugin. Duplicating full courses and assignments requires Masteriyo Pro (assignments also need the Assignments add-on). This makes it easier to create similar content with the click of a button.
