...
<Callout>
  {" "}  **Note:** Free and Sequential features are available in Masteriyo Free. For additioanl features such as Date Selection and X days from Enrollemnet [Content Drip add-on](https://docs.masteriyo.com/premium-addons/content-drip) is required. 
</Callout>
