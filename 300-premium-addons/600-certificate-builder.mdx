...
excerpt: Learn how to create Certificate templates and assign to the courses. Provide certificates to encourage students to complete the course.
---
...
![Available Certificate Template](https://raw.githubusercontent.com/Masteriyo/masteriyo-docs/main/assets/images/certificate-builder.png)
...
If you don’t find the font of your choise, you can also use the custom font. For that, follow the steps below:  
  ...
  2. Click on the setting icon on the top right corner
...
3. Click on **Save Setting** and go back to certificate builder.   
...
The certificate with QR might look similaar to the image below that varies depending on your styling or template used:
