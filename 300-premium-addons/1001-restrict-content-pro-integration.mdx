...
excerpt: Integrate Restrict Content Pro with Masteriyo to restrict course access by membership level, access level, or user role and monetize your courses.
---

The Restrict Content Pro Integration add-on helps you monetize and manage course access within Masteriyo.
...
4. [Restrict Content Pro Addon](/getting-started/activate-masteriyo-addons).        
...
1.  **Everyone**: The content is accessible to everyone, with no restrictions.
...
4.  **Members with a certain role**: You can choose the required user roles for the content to be accessed.
        ...
        Note: As mentioned above, membership levels are created with the Restrict Content Pro plugin.
