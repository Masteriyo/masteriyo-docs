...
excerpt: Manually enroll students in courses without checkout — single or bulk enrollment via CSV import, plus manual group enrollment for teams.
---

<Callout>
  This page describes the legacy Manual Enrollment add-on. As of the 3.4.0
  release, manual and bulk enrollment is now handled by the free, built-in
  Enrollments screen at **Masteriyo → Enrollments**. This page will be
  updated/retired shortly — use the new
  [<u>Enrollments screen</u>](/student-management/enrollments) for new setups.
</Callout>
...
3. [Activate the Manual Enrollment Add-on](/getting-started/activate-masteriyo-addons)
...
Once you have activated the Manual Enrollment add-on, navigate to the following location.
        ...
        Masteriyo > Users > Manual Enrollment
...
To see all the students who are manually enrolled, go to Masteriyo > Users > Manual Enrollment. If you want to make any changes to the course, you can click on **Edit**.
...
### Group Enrollment Prerequisites

1. [Activate the Groups Add-on](/free-addons/group-course).
