...
1. Get [Masteriyo LMS Pro plan or higher](https://masteriyo.com/pricing/).
2. [Install and activate Masteriyo LMS](/getting-started/installation#installing-masteriyo-lms-pro-version).
3. Activate the [Zoom Integration add-on](/getting-started/activate-masteriyo-addons).
...
Now, you will be able to find the necessary credentials to integrate Zoom with Masteriyo. Copy these details to your clipboard.

![app-credentials](https://user-images.githubusercontent.com/75772539/232450020-b3e8a4d1-615b-4935-8b24-d6371c53b07e.png)

After getting the credentials, you will have to provide access to the Zoom app for the integration. Simply, click **Continue** to move forward. Now, provide the necessary information like Company Name, developer's name, and email, and click **Continue**.
...
<Callout>
  {" "}  
  Find the list of required scopes [here](/premium-addons/zoom-integration#list-of-required-scopes)
</Callout>
...
You will have to set the time zone in your Zoom profile to make this integration work. For this, log in to your account and go to your profile. You will find an option called **Time Zone**. Click on the Edit button and set your time zone and save the changes.
...
Once you have created and activated the Zoom App, you will have to add the given Account ID, Client ID and Client Secret to the Masteriyo plugin to host Zoom Meetings. For this, navigate to **Masteriyo > Zoom > Settings** and add the required credentials.
...
Please note that there are various other options that you can set in the meeting builder area. These options are as described below.
...
- **Focus Mode** - Enable this to allow attendees to hide additional notifications and eliminate distractions.
