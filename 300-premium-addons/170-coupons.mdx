---
title: Coupons
excerpt: "Create and apply coupon codes in Masteriyo: fixed or percentage discounts, automatic coupons, stackable rules, usage limits, and expiry dates."
---
...
3. Enable the [Coupons Add-on](/getting-started/activate-masteriyo-addons).
...
<Callout>
  {" "} 
  **Note**: If you add another code on the Checkout form, it
