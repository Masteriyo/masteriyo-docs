...
Choosing this option means that the flow of the content is random. The users can jump from the first lesson/quiz, let’s say the last, without completing the courses in the middle. 
