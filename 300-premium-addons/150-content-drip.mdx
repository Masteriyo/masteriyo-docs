...
2. Enable the [Wishlist Add-on](https://docs.masteriyo.com/premium-addons/activate-masteriyo-premium-addons)
...
Unlike the Free option, this option sets a sequential rule for your lesson/quiz. Now the users will have to complete the first lesson/quiz to move forward to the lesson/quiz following. 
...
1. The data can be set from Builder > Lessons/Quizzes. 
...
This option lets you choose to unlock the lessons/quizzes after a number of days from enrollment. 
1. The days are also set at Builder > Lessons/Quizzes. 
2. Click on the edit icon for the desired lesson/quiz.
...
<Callout> **Note:** Free and Sequential features are available in Masteriyo Pro. Content Drip add-on is required to enable Date Selection and X Days from Enrollment feature. </Callout>
