...
3. Enable the [Content Drip Add-on](https://docs.masteriyo.com/getting-started/activate-masteriyo-addons).
...
Once you [activate the plugin](https://docs.masteriyo.com/getting-started/installation#installing-masteriyo-lms-pro-version) and enable the add-on, follow the steps below.
