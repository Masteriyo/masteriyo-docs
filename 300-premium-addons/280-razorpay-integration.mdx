...
excerpt: The "Razorpay" addon by Masteriyo enables secure and seamless transactions on your site using Razorpay payment gateway.
---
...
- Activate the [RazorPay Integration add-on](https://docs.masteriyo.com/getting-started/activate-masteriyo-addons)
