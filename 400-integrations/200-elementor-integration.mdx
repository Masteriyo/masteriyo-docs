...
<Callout> Click on the Course List element that you have just dragged into the widget and you will see the options to set under the General tab on the right sidebar. </Callout>
...
- **Categories** - Select the list of categories to include/exclude on the course ards.
...
<Callout> Click on the Course Category element that you have just dragged into the widget and you will see the options to set under the General tab on the right sidebar. </Callout>
