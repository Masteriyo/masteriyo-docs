...
<Callout> **Note:** Do not forget to copy the License Key from your email, which you need for activating the Masteriyo pro features. </Callout>
...
<Callout> **Note:** If you’ve already used the free version of Masteriyo,  activating Masteriyo pro deactivates its free version automatically. </Callout>
