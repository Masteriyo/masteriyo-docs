...
excerpt: What data Masteriyo's optional usage tracking shares (site URL, WordPress/PHP versions, active plugins) and how to enable it.
---
...
- published course count: Total number of courses published via Masteriyo plugin
- completed order count: Total number of orders completed with the Masteriyo plugin
...
> Also, you will receive occasional emails notifying you about new features or recent security updates.
