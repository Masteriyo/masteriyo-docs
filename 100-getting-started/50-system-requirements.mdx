...
| ---------------- | --------------- | --------------------- |
| WordPress        | 6.6 or higher   | Latest stable version |
...
### Small to Medium Sites (up to 1,000 students)

If you do use shared hosting for a smaller site, make sure it provides at least:
